...
interface ImageInputProps {
  ...
  onServerSelectRequest: (index: number) => void;
...
const ImageInput: React.FC<ImageInputProps> = React.memo(({ index, image, onFileSelect, onServerSelectRequest, onUpload, onClear, disabled, theme, allowRemote }) => {
